...
public class SearchController {
    ...
    @GetMapping("/byCocktailName")
    public String searchByCocktailName(Model model) {
        model.addAttribute(new Search());
        return "search/byCocktailName";
    }

    @PostMapping("/byCocktailResults")
    public String searchByCocktailName (@ModelAttribute Search search, Errors errors, Model model) throws IOException, InterruptedException {
        if (errors.hasErrors()) {
            System.out.println(errors.getAllErrors().toString());
            return "search/byCocktailName";
        }
        HttpClient client = HttpClient.newHttpClient();
        String url = "https://www.thecocktaildb.com/api/json/v1/1/search.php?s=" +search.getSearchParameter();
        ...
        return "search/byCocktailResults";
    }
